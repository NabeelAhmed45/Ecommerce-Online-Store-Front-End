...
const Foreveryoneitems = ({data, loading, error}) => {
  ...
  return (
    <div className="bg-[url('../../img/artificial-photography-vB5qtt8X4NA-unsplash.jpg')]">
        <h1 className='text-center text-2xl font-bold pt-6'>Universal Section</h1>
        <hr class=" my-6 border-gray-700 sm:mx-auto dark:border-gray-700 lg:my-8" />
    <div className='flex flex-wrap gap-11 ml-4'>
        {data
        .filter((value) => value.id === 36 || value.id === 37 || value.id === 39 || value.id === 40 || value.id === 41 || value.id === 42 || value.id === 43 || value.id === 44)
        .map((value) =>(
...
export default Foreveryoneitems