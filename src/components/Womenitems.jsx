...
const Womenitems = ({data, loading, error}) => {
  ...
  return (
    <div className="bg-[url('../../img/artificial-photography-vB5qtt8X4NA-unsplash.jpg')]">
        <h1 className='text-center text-2xl font-bold pt-6'>Women Section</h1>
        <hr class=" my-6 border-gray-700 sm:mx-auto dark:border-gray-700 lg:my-8" />
    <div className='flex flex-wrap gap-11 ml-4'>
        {data
        .filter((value) => value.id === 15 || value.id === 16 || value.id === 17 || value.id === 47 || value.id === 48)
        .map((value) =>(
            ...
            <a href="#">
              <img className="rounded-t-lg h-56 m-4" src={value.images} alt={value.title} />
            </a>
            <div className="p-5">
              <a href="#">
